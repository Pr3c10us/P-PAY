...
const Fail = ({ errorMsg, setForm }) => {
    return (
        <div className="flex w-full max-w-[20rem] flex-col items-center space-y-14 place-self-center rounded-xl border-2  bg-neutral px-2 py-10 font-medium shadow-md xsm:justify-center xsm:space-y-14 xsm:py-10 xsm:px-8 sm:max-w-sm">
