...
const FormThree = ({
    ...
    return (
        <div className=" relative flex w-full max-w-md flex-col space-y-8 place-self-center rounded-xl border border-t-4 bg-neutral px-4 py-6 font-medium shadow-md sm:justify-center sm:space-y-8 sm:py-10 sm:px-8">
