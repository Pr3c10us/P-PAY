...
export default function App() {
    return (
        <main className="relative grid h-full grid-cols-1 gap-4 overflow-auto bg-vector-pattern bg-small py-8 px-4 2xsm:px-8 md:bg-big">
            <form
                autoComplete="off"
                className="flex h-48 w-full max-w-xl flex-col space-y-2 place-self-center rounded-xl border border-t-4 border-t-gray-200 bg-neutral px-2 pt-4 pb-4 shadow-md xsm:h-60 justify-center sm:space-y-4 sm:px-8 sm:pt-8"
            >
                ...
                <div className="flex w-full justify-center">
                    <button
                        type="submit"
                        className="h-8 w-24 xsm:w-32 animate-pulse rounded-lg bg-gray-200 py-1.5 text-white xsm:h-11 sm:w-44 sm:py-2 sm:text-xl"
                    ></button>
                </div>
            </form>
        </main>
